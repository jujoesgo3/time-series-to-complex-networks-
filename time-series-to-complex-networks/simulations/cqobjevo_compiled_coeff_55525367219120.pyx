...
include '/home/jj/.local/lib/python3.8/site-packages/qutip/cy/complex_math.pxi'

cdef class CompiledStrCoeff(StrCoeff):
    cdef double omega_quantum

    def set_args(self, args):
        self.omega_quantum=args['omega_quantum']

    cdef void _call_core(self, double t, complex * coeff):
        cdef double omega_quantum = self.omega_quantum

        coeff[0] = np.cos(omega_quantum * t)
